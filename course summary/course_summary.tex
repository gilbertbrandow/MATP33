...
It remains to identify $\mathrm{Hom}_R(R,R)$ with $R$. Right multiplication by $r \in R$ is a left $R$-module map $R \to R$, and composition reverses the order of multiplication, giving $\mathrm{Hom}_R(R,R) \cong R^{\mathrm{op}}$ as rings. Hence
\[
